...
public class BoardDBBean {
	...
	public static BoardDBBean getInstance() {	//공유를 하기 위한 메서드
		return instance;
	}
	
	// 컨넥션 풀에서 컨넥션을 구해오는 메서드
...
String sql="select * from (select rownum rnum, upload.* from ";
	...
	// 수정폼 : 상세 정보 구하기
	public BoardDataBean getContent(int num) { //select을 사용하는 메서드는 반드시 앞에 자료형(ex)BoardDataBean)이 와야한다.
		BoardDataBean board = new BoardDataBean();
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
