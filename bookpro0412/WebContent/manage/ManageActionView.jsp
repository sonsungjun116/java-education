...
<table border=1 width=800 align=center>
		...
		<c:forEach var="b" items="${managelist}">
			...
			<tr>
				...
				<th>${b.member_mile}</th> 				
				<%-- <th><a href="<%=request.getContextPath() %>/MileCharge.managedo?member_id=${b.member_id}">마일리지 관리</a></th> --%>
				<th><a href="./manage/MileCharge.jsp?member_id=${b.member_id}&member_mile=${b.member_mile}&member_grade=${b.member_grade}">마일리지 관리</a></th>
