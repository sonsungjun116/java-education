...
public class BookDAO {
	...
	public int qty(BookDTO book) {
		...
		try {
			...
			String sql="update book set book_stock=?, book_count=? where book_num=?";
			
			pstmt = con.prepareStatement(sql);
			pstmt.setInt(1, book.getBook_stock()-1);
			pstmt.setInt(2, book.getBook_count()+1);
